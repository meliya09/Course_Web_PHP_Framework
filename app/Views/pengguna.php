        ...
        <table class="table table-striped table-sm">
          <thead>
            <tr>
              ...
              <th scope="col">Kota ID</th>
              <th scope="col">Aksi</th>
            </tr>
          </thead>
          <tbody>
          <?php foreach($pengguna as $baris): ?>
            <tr>
              <td> <?=$baris->pengguna_id?> </td>
              <td> <?=$baris->pengguna_email?> </td>
              <td> <?=$baris->pengguna_sandi?> </td>
              <td> <?=$baris->kota_nama?> </td>
              <td> 
                <a href="<?= site_url("admin/penggunahapus/$baris->pengguna_id") ?>">hapus</a>
                <a href="<?= site_url("admin/penggunaform/$baris->pengguna_id") ?>">edit</a>
              </td>
            </tr>
          <?php endforeach ?>
          </tbody>
